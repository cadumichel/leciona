        ...
        <div className="bg-slate-50 dark:bg-slate-800/50 p-4 md:p-6 rounded-[24px] md:rounded-[40px] border border-slate-100 dark:border-slate-800">
          <div className="grid gap-3 md:gap-4">
            {schoolEvents.length > 0 ? schoolEvents.map(event => {
              ...
              return (
                <div key={event.id} className="bg-white dark:bg-slate-900 p-2.5 md:p-3 rounded-[20px] md:rounded-[24px] border border-slate-100 dark:border-slate-800 shadow-sm transition-all flex items-center gap-3 md:gap-4 hover:shadow-md" style={{ borderColor: `${eventColor}40` }}>
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-xl md:rounded-2xl flex flex-col items-center justify-center shrink-0" style={{ backgroundColor: `${eventColor}20`, color: eventColor }}>
